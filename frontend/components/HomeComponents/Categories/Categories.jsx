...
const Categories = () => {
  return (
    <section className={styles['home-categories']}>
      <div className={styles['home-categories__wrapper']}>
        <Link href='/categories/react'>
          <a className={styles['home-categories-card']}>
            <figure>
              <img
                className={styles['home-categories-card__img']}
                src='images/categories/react.jpg'
                alt='category logo'
              />
            </figure>
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>React</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/node'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Node</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/next'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Next</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/javascript'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>JavaScript</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/angular'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Angular</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/vue'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Vue</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/mern'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>MERN</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/laravel'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Laravel</h2>
              <p className={styles['home-categories-card__text']}>
                A free and open-source JavaScript software stack for building
                dynamic web sites and web applications.
              </p>
        ...
        <Link href='/categories/gatsby'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Gatsby</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/sass'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Sass</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/python'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Python</h2>
              <p className={styles['home-categories-card__text']}>
        ...
        <Link href='/categories/django'>
          <a className={styles['home-categories-card']}>
            ...
            <div className={styles['home-categories-card__content']}>
              <h2 className={styles['home-categories-card__title']}>Django</h2>
              <p className={styles['home-categories-card__text']}>
